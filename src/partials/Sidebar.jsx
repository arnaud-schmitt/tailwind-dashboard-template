        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 pretty-hovering ${
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 ${open && "rotate-180 animate-rotate-180"} ${!open && "animate-rotate-back-to-zero"}`} viewBox="0 0 12 12">
                              <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                            </svg>
                          </div>
                        </div>
                      </a>
                      <div className={`lg:hidden lg:sidebar-expanded:block 2xl:block max-h-500 ${!open && "max-h-0 animate-collapse-vertical overflow-hidden"} ${open && "max-h-500 animate-expand-vertical"}`}>
              ...
              {/* Network */}
              <SidebarLinkGroup activecondition={pathname.includes("network") || pathname.includes("traffic")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 pretty-hovering ${
                          pathname.includes("network") || pathname.includes("traffic") ? "" : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className={`shrink-0 fill-current ${pathname.includes('network') || pathname.includes('traffic') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      ...
                      <div className={`lg:hidden lg:sidebar-expanded:block 2xl:block ${!open && "max-h-0 animate-collapse-vertical overflow-hidden"} ${open && "max-h-500 animate-expand-vertical"}`}>
                        <ul className={`pl-8 mt-1`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              end
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 pretty-hovering ${open ? "" : "hover:text-gray-900 dark:hover:text-white"}`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                          setSidebarExpanded(true);
        ...
        <div className="pt-3 hidden lg:inline-flex 2xl:hidden justify-end mt-auto">
          <div className="w-12 pl-4 pr-3 py-2">
            <button className="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400" onClick={() => setSidebarExpanded(!sidebarExpanded)}>
              ...
              <svg className="shrink-0 fill-current text-gray-400 dark:text-gray-500 sidebar-expanded:rotate-180 animate-rotate-180" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
