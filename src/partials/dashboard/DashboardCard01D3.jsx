...
import LineChart01D3 from '../../charts/LineChart01D3';

function DashboardCard01D3() {
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Acme Plus (D3.js)</h2>
          {/* Menu button */}
      ...
      <div className="grow max-sm:max-h-[128px] xl:max-h-[128px]">
        ...
        <LineChart01D3 data={chartData.datasets[0].data} width={389} height={128} />
      </div>
    </div>
  );
}

export default DashboardCard01D3;
